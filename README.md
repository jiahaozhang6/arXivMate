...
- Main UI language: Chinese, with output language options for system default, Chinese, and English
...
- **Review library**: search papers you have read, reopen chat history, copy notes, or export Markdown.
...
- API key
- Model name
- Output language: system, Chinese, or English
...
- `chrome.storage.sync.settings`: model profiles, active model, output language, and appearance theme.
